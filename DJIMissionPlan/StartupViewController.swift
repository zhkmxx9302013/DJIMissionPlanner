...
class StartupViewController: UIViewController, DJISDKManagerDelegate {
    ...
    func productConnected() {
        guard let newProduct = DJISDKManager.product() else {
            ...
            self.view.makeToast("Product is connected but DJISDKManager.product is nil -> something is wrong")
            return;
        }
...
//        if newProduct.model == DJIAircraftModelNameMavicAir2{
//
//        }
        self.view.makeToast(newProduct.model)
        if newProduct.model == DJIAircraftModelNameMavicMini || newProduct.model == DJIAircraftModelNameMavicAir2{
